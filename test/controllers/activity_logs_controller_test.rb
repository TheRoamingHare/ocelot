...
class ActivityLogsControllerTest < ActionController::TestCase
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post :create, activity_log: { CurrentActivity: @activity_log.CurrentActivity, CurrentMood: @activity_log.CurrentMood }
    end
  ...
  test "should update activity_log" do
    patch :update, id: @activity_log, activity_log: { CurrentActivity: @activity_log.CurrentActivity, CurrentMood: @activity_log.CurrentMood }
    assert_redirected_to activity_log_path(assigns(:activity_log))
  end
